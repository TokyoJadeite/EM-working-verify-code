        ...
        <div class="tab-content <?= $activeTab === 'profile' ? 'active' : '' ?>">
            <div class="settings-card">
                <div class="settings-card-header">
                    <div class="icon-circle" style="background: rgba(139, 92, 246, 0.1); color: var(--color-admin);">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div style="font-size: 0.72rem; color: var(--text-muted); margin-top: 0.3rem;">
                                <i class="fa-solid fa-lock" style="font-size: 0.6rem;"></i> Email cannot be changed for security reasons.
                            </div>
                        </div>
                        <div class="form-group">
